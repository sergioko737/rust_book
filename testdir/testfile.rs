...
change  2020-10-16 08:03:14  ✌️  version 2.0.0-SOMECHANGE47f7d3f2e-x86_64-linux-gnu🔒
...
substrate/client/cli/src/runner.rs: SOMECHANGE	info!("👤 Role: {}", config.display_role());
